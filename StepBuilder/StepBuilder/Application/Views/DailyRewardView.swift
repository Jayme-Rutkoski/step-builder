...
class DailyRewardView: UIView {
    ...
    private lazy var labelTitle: UILabel = {
        ...
        label.font = FontHelper.getSignPainterSemiBoldFont(size: 20)
    ...
    private func displayOnViewController(_ viewController: UIViewController) {
        ...
        viewController.view.bringSubviewToFront(self.buttonClaim)
    }
    ...
    public func displayView(_ viewController: UIViewController) {
